...
class AdService:
    ...
    def engine(self) -> RecommendationEngine:
        ...
        if self._engine is None:
            config = RecommendationConfig(
                ...
                ranking_strategy=RankingStrategy.CPM,
    ...
    async def serve_ads(
        ...
        3. Rank by CPM bid (higher CPM wins)
        4. Return top candidates with video tracking URLs
        """
        ...
        # Remove candidates bidding below the SSP-specified floor
        bid_floor = request.bid_floor
        if bid_floor and bid_floor > 0:
